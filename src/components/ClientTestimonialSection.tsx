...
const ClientTestimonialSection = () => {
  return (
    <section className="bg-neutral-950 py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        {/* Section Label */}
        <div className="inline-flex items-center px-4 py-1.5 mb-6 border border-gray-700 rounded-full">
        ...
        <div className="mt-8 mb-10">
          <div className="flex">
            <span className="text-yellow-400 text-4xl font-serif leading-none mr-2">"</span>
          ...
          <div className="flex items-center mt-6">
            <div className="h-10 w-10 rounded-full bg-gray-800 overflow-hidden flex-shrink-0">
              <img 
            ...
            <div className="ml-3">
              <h4 className="text-white font-bold">Mr. John Doe</h4>
        ...
        {/* Video Card */}
        <div className="relative mt-10 rounded-3xl overflow-hidden group">
          <img 
          ...
          <div className="absolute inset-0 bg-black/20 flex items-center justify-center group-hover:bg-black/30 transition-colors duration-300">
            <button 
              className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-xl transform transition-transform hover:scale-110"
